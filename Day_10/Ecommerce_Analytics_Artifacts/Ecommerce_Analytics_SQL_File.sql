...
CREATE OR REPLACE VIEW RAW.MV_DAILY_SALES_SUMMARY
AS
SELECT
...
CREATE OR REPLACE VIEW RAW.MV_RETURNS_BY_CHANNEL
AS
SELECT
...
CREATE OR REPLACE VIEW RAW.MV_INVENTORY_HEALTH
AS
SELECT
...
-- ============================================================
-- 8️  SEARCH OPTIMIZATION (Requires Enterprise Edition — skipped)
-- ============================================================
